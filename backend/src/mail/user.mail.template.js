	...
	max-width: 560px;" class="container">
          <tr>
			...
			font-family: sans-serif;" class="header">
              <div style="font-size: 32px; font-weight: bold; color: #c3e1e1; text-transform: uppercase; letter-spacing: 3px;">AURA</div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
			...
			font-family: sans-serif;" class="paragraph">
              Welcome to AURA!<br> In order to start using your new emotional intelligence account, you need to confirm your email address.
            </td>
          </tr>
          <tr>
            <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			padding-bottom: 5px;" class="button">
              <a href="https://aura-backend-11z6.onrender.com/api/users/verify/${mailToken}" target="_blank" style="text-decoration: underline;">
                <table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;">
                  <tr>
					...
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="https://aura-backend-11z6.onrender.com/api/users/verify/${mailToken}">
          ...
          <tr>
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
              If you did not sign up for AURA, you can ignore this email and the account will be deleted.
            </td>
          </tr>
        </table>
	...
	max-width: 560px;" class="wrapper">
          <tr>
			...
			font-family: sans-serif;" class="footer">
              Welcome to your emotional intelligence journey with AURA. Our support team is here to help you explore and understand your emotions better.
            </td>
          </tr>
        </table>
      </td>
